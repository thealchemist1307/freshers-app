...
class Loading extends Component{
    constructor(props){
        super(props)
        setTimeout(this._loading,3000)
    }
    _loading=()=>{this.props.navigation.navigate('App')}
    ...
    const styles = StyleSheet.create({
        ...
        return(   
            ...
            <ImageBackground source={require("./images/welcome.jpg")} style={styles.backgroundImage} >
